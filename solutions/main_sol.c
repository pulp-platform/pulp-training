...
int main()
{
  ...
  while(1) {
    left_to_right_on_slow(LED_0, LED_7);
    left_to_right_off_slow(LED_0, LED_7);

    waste_time();

    left_to_right_on(LED_0, LED_7);
    left_to_right_off(LED_0, LED_7);

    waste_time();

    left_to_right_single(LED_0, LED_7);
    left_to_right_single(LED_0, LED_7);
    left_to_right_single(LED_0, LED_7);
  }
